    ...
    <div class="wrapper d-flex flex-column flex-row-fluid container-xxl" id="kt_wrapper">
        ...
        <div class="toolbar d-flex flex-stack flex-wrap py-4 gap-2" id="kt_toolbar">
            ...
            <div class="page-title d-flex flex-column align-items-start me-3 gap-1">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bold m-0 fs-3">All Feature</h1>
                <!--end::Title-->
            ...
            <div class="content flex-row-fluid" id="kt_content">               
                ...
                <div class="card">                 
                    ...
                    <div class="card-body py-4">
                        <!--begin::Table-->               
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="feature_datatable">
                            <!--begin::Table head-->
                            <thead>
                                <!--begin::Table row-->
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                <!--begin::Table row-->
                                <tr v-for="features in All_features">
                                    <td><span> {{ features.name }} </span></td>
                                    <td><span> {{ features.description }} </span></td>
                                    <td><router-link :to="'/edit_feature/' + features.uuid" class="btn btn-sm btn-primary">Edit</router-link>&nbsp;<button class="btn btn-sm btn-danger" @click="deleteFeature(features.uuid)">Delete </button></td>
                                </tr>
                                <!--end::Table row-->
                            </tbody>
                            <!--end::Table body-->
