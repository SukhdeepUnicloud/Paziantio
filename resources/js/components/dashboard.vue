                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-center flex-column py-5">
                                    ...
                                    <div class="symbol symbol-100px symbol-circle mb-7">
                                        ...
                                        <img v-if="this.loggedUser.image !='Null'"  class="image-input-wrapper w-100px h-100px"  :src="'./assets/app/public/user_profiles/'+loggedUser.id+'/users/avatar/'+loggedUser.image+''" alt="profile image" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{loggedUser.name}}</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="mb-9">
                                        <!--begin::Badge-->
                                        <div class="badge badge-lg badge-light-primary d-inline">Role {{loggedUser.role}}   <br> <router-link to="/settings" class="btn btn-sm btn-danger" >Edit Details</router-link></div>
                                        <!--begin::Badge-->
                                    </div>
                                ...
                                <div id="kt_user_view_details" class="collapse show">
                                    <div class="pb-5 fs-6">
                                        ...
                                        <div class="text-gray-600">ID-{{loggedUser.id}}</div>
                                        <!--begin::Details item-->
                                        <!--begin::Details item-->
                                        <div class="fw-bold mt-5">Email</div>
                                        <div class="text-gray-600">
                                            <a href="#" class="text-gray-600 text-hover-primary">{{loggedUser.email}}</a>
                                        </div>
                                        <!--begin::Details item-->
                                        <!--begin::Details item-->
                                        <div class="fw-bold mt-5">Address Street</div>
                                        <div class="text-gray-600">{{loggedUser.street}}</div>
                                        <!--begin::Details item-->
                                        <!--begin::Details item-->
                                        <div class="fw-bold mt-5">Street No</div>
                                        <div class="text-gray-600">{{loggedUser.street_no}}</div>
                                        <!--begin::Details item-->
                                        <!--begin::Details item-->
...
export default {
    ...
    mounted() {
        ...
        console.log(this.loadData());console.log(this.currentUserData());
    }
}
