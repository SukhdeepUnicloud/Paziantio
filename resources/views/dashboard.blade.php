				...
				<div class="wrapper d-flex flex-column flex-row-fluid container-xxl" id="kt_wrapper">
					...
					<div class="toolbar d-flex flex-stack flex-wrap py-4 gap-2" id="kt_toolbar">
						...
						<div class="page-title d-flex flex-column align-items-start me-3 gap-1">
							<!--begin::Title-->
							<h1 class="d-flex text-dark fw-bold m-0 fs-3">View User Details</h1>
							<!--end::Title-->
							<!--begin::Breadcrumb-->
						...
						<div class="d-flex align-items-center py-1">
							...
							<div class="me-2">
								...
								<!--begin::Menu 1-->
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_633e7b1172602">
									<!--begin::Header-->
									<div class="px-7 py-5">
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<!--begin::Input-->
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_633e7b1172602" data-allow-clear="true">
													<option></option>
										...
										<div class="card-body">
											...
											<div class="d-flex flex-center flex-column py-5">
												...
												<div class="symbol symbol-100px symbol-circle mb-7">
													<img src="assets-dashboard/media/avatars/300-6.jpg" alt="image" />
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
											...
											<div id="kt_user_view_details" class="collapse show">
												<div class="pb-5 fs-6">
													...
													<div class="text-gray-600">22 Sep 2022, 9:23 pm</div>
													<!--begin::Details item-->
												</div>
											</div>
											<!--end::Details content-->
										...
										<div class="card-body pt-2">
											...
											<div class="py-2">
												...
												<div class="d-flex flex-stack">
													<div class="d-flex">
														<img src="assets-dashboard/media/svg/brand-logos/google-icon.svg" class="w-30px me-6" alt="" />
												...
												<div class="d-flex flex-stack">
													<div class="d-flex">
														<img src="assets-dashboard/media/svg/brand-logos/github.svg" class="w-30px me-6" alt="" />
														<div class="d-flex flex-column">
												...
												<div class="d-flex flex-stack">
													<div class="d-flex">
														<img src="assets-dashboard/media/svg/brand-logos/slack-icon.svg" class="w-30px me-6" alt="" />
														<div class="d-flex flex-column">
														...
														<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
															...
															<tbody>
																...
																<tr>
																	...
																	<!--end::Badge=-->
																	<!--begin::Status=-->
																	<td>POST /v1/customer/c_633e7b1178379/not_found</td>
																	<!--end::Status=-->
																	<!--begin::Timestamp=-->
																...
																<tr>
																	...
																	<!--end::Badge=-->
																	<!--begin::Status=-->
																	<td>POST /v1/invoices/in_4152_6837/payment</td>
																	<!--end::Status=-->
																	<!--begin::Timestamp=-->
																	<td class="pe-0 text-end min-w-200px">10 Mar 2022, 6:43 am</td>
																	<!--end::Timestamp=-->
																</tr>
																<!--end::Table row-->
																<!--begin::Table row-->
																<tr>
																	...
																	<!--end::Badge=-->
																	<!--begin::Status=-->
																	<td>POST /v1/invoices/in_7175_6197/payment</td>
																	<!--end::Status=-->
																	<!--begin::Timestamp=-->
																	<td class="pe-0 text-end min-w-200px">20 Jun 2022, 6:05 pm</td>
																	<!--end::Timestamp=-->
																</tr>
																<!--end::Table row-->
																<!--begin::Table row-->
																<tr>
																	...
																	<!--end::Status=-->
																	<!--begin::Timestamp=-->
																	<td class="pe-0 text-end min-w-200px">21 Feb 2022, 11:30 am</td>
																	<!--end::Timestamp=-->
																</tr>
																<!--end::Table row-->
																<!--begin::Table row-->
																<tr>
																	...
																	<!--end::Badge=-->
																	<!--begin::Status=-->
																	<td>POST /v1/invoice/in_8406_9548/invalid</td>
																	<!--end::Status=-->
																	<!--begin::Timestamp=-->
													...
													<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
														...
														<tbody>
															...
															<tr>
																...
																<!--end::Event=-->
																<!--begin::Timestamp=-->
																<td class="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2022, 11:30 am</td>
																<!--end::Timestamp=-->
															</tr>
															<!--end::Table row-->
															<!--begin::Table row-->
															...
															<tr>
																...
																<!--end::Event=-->
																<!--begin::Timestamp=-->
																<td class="pe-0 text-gray-600 text-end min-w-200px">10 Mar 2022, 10:10 pm</td>
																<!--end::Timestamp=-->
															</tr>
															<!--end::Table row-->
															<!--begin::Table row-->
													...
													<div id="kt_modal_update_user_user_info" class="collapse show">
														...
														<div class="mb-7">
															...
															<div class="mt-1">
																...
																<style>.image-input-placeholder { background-image: url('assets-dashboard/media/svg/avatars/blank.svg'); } [data-theme="dark"] .image-input-placeholder { background-image: url('assets-dashboard/media/svg/avatars/blank-dark.svg'); }</style>
																<!--end::Image placeholder-->
																<!--begin::Image input-->
																<div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
																	<!--begin::Preview existing avatar-->
																	<div class="image-input-wrapper w-125px h-125px" style="background-image: url(assets-dashboard/media/avatars/300-6.jpg"></div>
										...
										<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
											...
											<div class="fw-bold d-flex flex-column justify-content-center mb-5">
												...
												<div class="d-flex flex-center" data-kt-add-auth-action="qr-code">
													<img src="assets-dashboard/media/misc/qr.png" alt="Scan this QR code" />
												</div>
												<!--end::QR code-->
												<!--begin::Text code-->
