			...
			<div class="content flex-row-fluid" id="kt_content">
								...
								<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
									...
									<div class="d-flex flex-column">
										...
										<div class="d-flex align-items-center mb-2">
											<a href="#"
												class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{loggedUser.name}}</a>
											<a href="#">
										...
										<div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
											...
											<a href="#"
												...
												<!--end::Svg Icon-->{{loggedUser.street}} , {{loggedUser.country}}
											</a>
											<a href="#"
				...
				<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
					...
					<div class="card-header cursor-pointer">
						...
						<!--end::Card title-->
						<!--begin::Action-->
						<router-link to="/settings" class="btn btn-primary align-self-center">Edit
							Profile</router-link>
						<!--end::Action-->
					</div>
					<!--begin::Card header-->
					...
					<div class="card-body p-9">
						...
						<div class="row mb-7">
							...
							<!--begin::Col-->
							<div class="col-lg-8">
								<span class="fw-bold fs-6 text-gray-800">{{loggedUser.name}}</span>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Row-->
						...
						<div class="row mb-7">
							...
							<div class="col-lg-8 fv-row">
								<span class="fw-semibold text-gray-800 fs-6">{{loggedUser.street}}</span>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Input group-->
						...
						<div class="row mb-7">
							...
							<div class="col-lg-8 d-flex align-items-center">
								<span class="fw-bold fs-6 text-gray-800 me-2">{{loggedUser.phone}}</span>
						...
						<div class="row mb-7">
							<!--begin::Label-->
							<label class="col-lg-4 fw-semibold text-muted">Street No:</label>
							<!--end::Label-->
							<!--begin::Col-->
							<div class="col-lg-8">
								<a href="#" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{loggedUser.street_no}}</a>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Input group-->
						...
						<div class="row mb-7">
							...
							<!--begin::Col-->
							<div class="col-lg-8">
								<span class="fw-bold fs-6 text-gray-800">{{loggedUser.country}}</span>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Input group-->
						...
						<div class="row mb-7">
							...
							<!--begin::Col-->
							<div class="col-lg-8">
								<span class="fw-bold fs-6 text-gray-800">{{loggedUser.email}}</span>
							</div>
							<!--end::Col-->
						</div>
						<!--end::Input group-->
						...
						<div class="row mb-10">
							...
							<!--begin::Label-->
							<!--begin::Label-->
							<div class="col-lg-8" v-if="loggedUser.two_factor == 1">
