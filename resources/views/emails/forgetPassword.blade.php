				...
				<td align="left" valign="center">
					<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
						...
						<div style="padding-bottom: 40px; text-align:center;">
							<a href="http://127.0.0.1:8000/confirm_password/{{$body['token']}}/{{$body['email']}}" rel="noopener" style="text-decoration:none;display:inline-block;text-align:center;padding:0.75575rem 1.3rem;font-size:0.925rem;line-height:1.5;border-radius:0.35rem;color:#ffffff;background-color:#50CD89;border:0px;margin-right:0.75rem!important;font-weight:600!important;outline:none!important;vertical-align:middle" target="_blank">Reset Password</a>
						</div>
						...
						<div style="padding-bottom: 50px; word-wrap: break-all;">
							...
							<a href="http://127.0.0.1:8000/confirm_password/{{$body['token']}}/{{$body['email']}}" rel="noopener" target="_blank" style="text-decoration:none;color: #50CD89">http://127.0.0.1:8000/confirm_password/{{$body['token']}}/{{$body['email']}}</a>
						</div>
						<!--end:Email content-->
