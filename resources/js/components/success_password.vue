				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							<!--begin::Logo-->
							<div class="mb-14">
								<a href="../../demo19/dist/index.html" class="">
									<img alt="Logo" src="assets/media/logos/custom-2.svg" class="h-40px" />
								</a>
							</div>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder text-gray-900 mb-5">Your Account Password is changed</h1>
							<!--end::Title-->
							<!--begin::Message-->
							<div class="fs-6 fw-semibold text-gray-500 mb-10">This is your opportunity to get creative
							<a href="#" class="link-primary fw-semibold">Physio Software</a>
							<br />that gives readers an idea</div>
							<!--end::Message-->
							<!--begin::Link-->
							<div class="mb-11">
								<router-link to="/login" class="btn btn-sm btn-primary">Go to Home</router-link>
							</div>
							<!--end::Link-->
							<!--begin::Illustration-->
							<div class="mb-0">
