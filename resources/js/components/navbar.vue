        ...
        <div class="header-top-container container-xxl sabi d-flex flex-grow-1 flex-stack">
            ...
            <div class="d-flex align-items-center me-5">
                ...
                <router-link to="/dashboard">
                    <!--begin::Desktop modes-->
                    <img alt="Logo" src="assets-dashboard/media/logos/default-dark.svg"
                        class="d-none d-lg-inline-block h-30px" />
                    <!--end::Desktop modes-->
            ...
            <div class="topbar d-flex align-items-stretch flex-shrink-0" id="kt_topbar">
                ...
                <div class="d-flex align-items-center ms-2 ms-lg-3">
                    ...
                    <div class="btn btn-icon btn-custom w-30px h-30px w-md-40px h-md-40px" id="kt_activities_toggle">
                        ...
                        <select class="lang" v-model="$i18n.locale" id="locale">
                ...
                <div class="d-flex align-items-center ms-2 ms-lg-3">
                    <!--begin::Menu- wrapper-->
                    <div class="btn btn-icon btn-custom w-30px h-30px w-md-40px h-md-40px position-relative"
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                            style="background-image:url('assets-dashboard/media/misc/menu-header-bg.jpg')">
                            <!--begin::Title-->
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="image"
                                            src="assets-dashboard/media/illustrations/sketchy-1/1.png" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
                ...
                <div class="d-flex align-items-center ms-2 ms-lg-3">
                    <!--begin::Menu wrapper-->
                    <div class="btn btn-icon btn-custom w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click"
                ...
                <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                        data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img class="image-input-wrapper w-40px h-40px"  :src="'./assets/app/public/user_profiles/'+loggedUser.id+'/users/avatar/'+loggedUser.image+''" alt="image" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">{{ user.name }}
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ user.role
                                        }}</span>
                                    </div>
                        ...
                        <div class="menu-item px-5" v-if="user.role == 'Admin'">
                            <router-link to="/all_users" class="menu-link px-5">{{$t("all_users")}}</router-link>
                        </div>
                        <div class="menu-item px-5" v-if="user.role == 'Admin'">
                            <router-link to="/add_role" class="menu-link px-5">{{$t("role")}}</router-link>
                        </div>

                        <div class="menu-item px-5">
                            <router-link to="/profile" class="menu-link px-5">{{$t("profile")}}</router-link>
                        </div>

                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a class="menu-link px-5" @click="logout">{{$t("sign_out")}}</a>
            ...
            <div class="header-menu container-xxl flex-column align-items-stretch flex-lg-row" data-kt-drawer="true"
                ...
                <div class="menu menu-column menu-lg-row menu-rounded menu-active-bg menu-title-gray-800 menu-state-primary menu-arrow-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch flex-grow-1 px-2 px-lg-0"
                            ...
                            <div class="menu-state-bg menu-extended overflow-hidden" data-kt-menu-dismiss="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo19/dist/dashboards/ecommerce.html"
                                                        class="menu-link">
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo19/dist/dashboards/projects.html"
                                                        class="menu-link">
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo19/dist/dashboards/online-courses.html"
                                                        class="menu-link">
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                            <!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo19/dist/dashboards/marketing.html"
                                                        class="menu-link">
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo19/dist/dashboards/call-center.html"
                                                        class="menu-link">
                                                        <span
                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                        ...
                                        <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                                            ...
                                            <a href="../../demo19/dist/landing.html"
                                    ...
                                    <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo19/dist/dashboards/logistics.html"
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo19/dist/dashboards/website-analytics.html"
                                                class="menu-link py-2">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo19/dist/dashboards/finance-performance.html"
                                                class="menu-link py-2">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo19/dist/dashboards/store-analytics.html"
                                                class="menu-link py-2">
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        ...
                        <span class="menu-link py-3">
                            <router-link to="/add_company"> 
                                <span class="menu-title">{{ $t("add_company") }}</span>
                                <span class="menu-arrow d-lg-none"></span>
                            </router-link>
                        </span>
                        <!--end:Menu link-->
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        ...
                        <!--begin:Menu link-->
                        <span class="menu-link py-3">
                            <router-link to="/add_location"> 
                                <span class="menu-title">{{ $t("add_location") }}</span>
                                <span class="menu-arrow d-lg-none"></span>
                            </router-link>
                        </span>
                        <!--end:Menu link-->
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        ...
                        <!--begin:Menu link-->
                        <span class="menu-link py-3">
                            <router-link to="/add_room"> 
                                <span class="menu-title">{{ $t("add_room") }}</span>
                                <span class="menu-arrow d-lg-none"></span>
                            </router-link>
                        </span>
                        <!--end:Menu link-->
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        ...
                        <!--begin:Menu link-->
                        <span class="menu-link py-3">
                            <router-link to="/add_feature"> 
                                <span class="menu-title">{{ $t("add_feature") }}</span>
                                <span class="menu-arrow d-lg-none"></span>
                            </router-link>
                        </span>
                        <!--end:Menu link-->
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                        ...
                        <!--begin:Menu link-->
                        <span class="menu-link py-3">
                            <router-link to="/Formio"> 
                                <span class="menu-title">Form IO</span>
                                <span class="menu-arrow d-lg-none"></span>
                            </router-link>
                        </span>
                        <!--end:Menu link-->
